...
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE cadastro.imovel_tipo_ocupante TO pg_aplic;
GRANT SELECT ON TABLE                         cadastro.imovel_tipo_ocupante TO pg_users;
...
GRANT SELECT, UPDATE ON TABLE cadastro.seq_imovel_tipo_ocupante TO pg_aplic;
GRANT SELECT ON TABLE         cadastro.seq_imovel_tipo_ocupante TO pg_users;
