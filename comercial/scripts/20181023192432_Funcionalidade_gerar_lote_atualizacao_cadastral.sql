...
VALUES (nextval('seguranca.seq_funcionalidade'), 1, 'Gerar Lote Atualizacao Cadastral', now(), 'Gsan/Cadastro/Atualizacao Cadastral',
        'exibirFiltrarGerarLoteAtualizacaoCadastralAction.do', 1, 'ExLtRec', 121,  2, 2, 10, null);
...
INSERT INTO seguranca.funcionalidade
VALUES (nextval('seguranca.seq_funcionalidade'), 1, 'Concluir Gerar Lote Atualizacao Cadastral', now(), 'Gsan/Cadastro/Atualizacao Cadastral',
...
INSERT INTO seguranca.operacao
VALUES (nextval('seguranca.seq_operacao'), (SELECT fncd_id FROM seguranca.funcionalidade WHERE fncd_dsfuncionalidade LIKE 'Concluir Gerar Lote Atualizacao Cadastral'), 'Concluir Gerar Lote Atualizacao Cadastral',
...
INSERT INTO seguranca.grupo_func_operacao
VALUES (1, (SELECT oper_id FROM seguranca.operacao WHERE oper_dsoperacao LIKE 'Concluir Gerar Lote Atualizacao Cadastral'),
        (SELECT fncd_id FROM seguranca.funcionalidade WHERE fncd_dsfuncionalidade LIKE 'Concluir Gerar Lote Atualizacao Cadastral'), now());

INSERT INTO seguranca.grupo_func_operacao
VALUES (73, (SELECT oper_id FROM seguranca.operacao WHERE oper_dsoperacao LIKE 'Concluir Gerar Lote Atualizacao Cadastral'),
        (SELECT fncd_id FROM seguranca.funcionalidade WHERE fncd_dsfuncionalidade LIKE 'Concluir Gerar Lote Atualizacao Cadastral'), now());
...
delete from seguranca.usuario_favoritos where fncd_id in (SELECT fncd_id FROM seguranca.funcionalidade WHERE fncd_dsfuncionalidade LIKE 'Concluir Gerar Lote Atualizacao Cadastral');

DELETE FROM seguranca.grupo_func_operacao
WHERE fncd_id IN (SELECT fncd_id FROM seguranca.funcionalidade WHERE fncd_dsfuncionalidade LIKE 'Concluir Gerar Lote Atualizacao Cadastral');

DELETE FROM seguranca.operacao WHERE oper_dsoperacao = 'Concluir Gerar Lote Atualizacao Cadastral';

DELETE FROM seguranca.funcionalidade WHERE fncd_dsfuncionalidade = 'Concluir Gerar Lote Atualizacao Cadastral';